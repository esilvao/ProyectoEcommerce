...
const CarrucelHome = () => {
  return (
    <>
      <Carousel style={{ textAlign: 'center', paddingTop: '10px' }}>
        <Carousel.Item>
        <img
            className="d-linea"
          ...
          <Carousel.Caption>
            <h3>Moda Mujer</h3>
            <p>Ropa y accesorios diseñados para la exigente mujer moderna.</p>
          </Carousel.Caption>
        </Carousel.Item>
...
/>
          ...
          <Carousel.Caption>
            <h3>Moda Hombre</h3>
            <p>Moda masculina desde lo clásico y elegante hasta lo moderno y casual.</p>
          </Carousel.Caption>
        </Carousel.Item>
